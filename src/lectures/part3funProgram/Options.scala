...
object Options extends App {
  ...
  // val result = Some(null) //Wrong. Do not do this
  val result = Option(unsafeMethod()) // This will return Some or None
  println(result)
  ...
  object Connection {
    ...
    def apply(host: String, post: String): Option[Connection] = {
